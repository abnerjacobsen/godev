...
patch-release: guard-GITHUB_TOKEN check-status check-release
	...
	tools/github-release release -u abnerjacobsen -r godev -t $(NEXT_PATCH) -n $(NEXT_PATCH) -d "**Changelog**<br/>$$changelog"
...
minor-release: guard-GITHUB_TOKEN check-status check-release
	...
	tools/github-release release -u abnerjacobsen -r godev -t $(NEXT_MINOR) -n $(NEXT_MINOR) -d "**Changelog**<br/>$$changelog"
...
major-release: guard-GITHUB_TOKEN check-status check-release
	...
	tools/github-release release -u abnerjacobsen -r godev -t $(NEXT_MAJOR) -n $(NEXT_MAJOR) -d "**Changelog**<br/>$$changelog"
